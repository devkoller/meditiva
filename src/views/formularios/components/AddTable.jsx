...
export const AddTable = ({ listArticles, SetListTable }) => {
  ...
  const columns = [
    { accessor: 'articulo', header: 'Articulo' },
    { accessor: 'codigoBarras', header: 'Código de barras', filter: 'text' },
    { accessor: 'lote', header: 'Lote', filter: 'text' },
    { accessor: 'cantidad', header: 'Cantidad', filter: 'text' },
    { accessor: 'precio', header: 'Precio individual', filter: 'text' },
    { accessor: 'precioTotal', header: 'Precio Total', filter: 'text' },
    {
      accessor: 'actions',
      title: 'Acciones',
      render: row => (
    ...
    <div>
      ...
      >
        ...
        <div className='flex gap-3 mt-3'>
          ...
          <FormInput label='Precio Individual' name='precio' required />
